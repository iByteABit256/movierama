...
public class MockDataInitializer implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    IntStream.rangeClosed(1, 5)
        .mapToObj(i -> new RegisterUserDTO("user" + i, "password", "user" + i + "@mail.com"))
  ...
  private <T> void saveAllEntities(
      List<T> entities, JpaRepository<T, ?> repository, String entityName) {
